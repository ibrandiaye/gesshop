                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control " id="depot_id" name="depot_id" required=""  {{ Auth::user()->role=="gestionnaire" ? "disabled='true'" : ''  }} >
                                            ...
                                            @else
                                            <option value="{{$depot->id}}" {{$facture->depot_id==$depot->id ? 'selected' : ''}} >{{$depot->nomd}}</option>
                                            @endif
                                                @endforeach
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <table class="table  table-bordered">
                                            ...
                                            <tbody class="conteneur">
                                                ...
                                                <tr>
                                                    <td><input type='hidden' value="{{ $sortie->produit_id }}" name='produit_id[]' required>{{ $sortie->produit->nomp }} </td>
                                                    <td><input type='number' value="{{ $sortie->quantite }}" name='quantite[]' class='form-control quant'  step='0.1' required> </td>
                                                    <td><input type='number' value="{{ $sortie->prixv }}" name='prix[]' class='form-control prix'  step='0.1' required> </td>
